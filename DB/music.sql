...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-04-2020 a las 18:18:59
...
INSERT INTO `favorites` (`idfavorites`, `likes`, `users`) VALUES
(1, 2, 5),
(2, 0, 0),
(3, 0, 0),
(4, 0, 0),
...
(11, 'POPULAR SPAIN', 'categories', 'view/img/categories2.jpg', 8),
...
CREATE TABLE `shopping` (
  ...
  `id_shopping` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `shopping` (`id`, `id_product`, `quantity`, `id_user`, `id_shopping`) VALUES
(92, '1', '3', '20', 0),
(93, '2', '2', '20', 0),
(94, '3', '1', '20', 0),
(95, '1', '3', '20', 1),
...
(113, 'A02', 'ProgrammerLife', 'LilXero', 'DAW', '07/01/2020', 'Pop:Blues:', '1:30', '10', '2', 46),
(127, 'A99', 'uihi', 'hi', 'kjb', '29/01/2020', 'Blues:', '1:53', '14', '4', 7),
...
(134, 'C01', 'categoriestest', 'categories', 'test', '27/02/2020', 'Rock:Pop:', '2:28', '10', '', 1),
...
--
ALTER TABLE `favorites`
  MODIFY `idfavorites` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
