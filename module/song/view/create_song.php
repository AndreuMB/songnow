<div id="contenido">
	<form method="post" name="create_song" id="create_song">
			...
			<input name="id_song" id="id_song" type="text" placeholder="id_song" value=""/>
        ...
        <p>
			...
			<input name="singer" id="singer" type="text" placeholder="singer" value=""/>
			<span id="e_singer" class="error"></span>
		</p>
        <p>
			<label for="album">album</label>
			<input name="album" id="album" type="text" placeholder="album" value=""/>
		...
		<p>
			...
			<input id="relase_date" type="text" name="relase_date" readonly="readonly" value="">
