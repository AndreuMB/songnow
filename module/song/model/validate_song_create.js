...
function validate_idsong(id_song) {
    console.log("idsong2");
    console.log(id_song);

    if (id_song.length > 0) {
        var regexp = /^[A-Z]{1}[0-9]{2}$/;
...
function validate_song_create() {
    ...
    var v_id_song = validate_idsong(id_song);
    ...
    document.create_song.submit();
    document.create_song.action="index.php?page=controller_songs&op=create";
    return result;
