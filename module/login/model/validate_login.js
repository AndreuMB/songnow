        ...
        '<div class="row">'+
            '<div class="col-12 col-12-medium">'+
                '<form method="post" id="formregister">'+
                    ...
                    '</div>'+
                    '</form>'+
                '<p>Already have an account? <a href="index.php?page=controller_login&op=list">Log in</a>.</p>'+
            '</div>'+
        '</div>'
    )
        ...
        '<div class="row">'+
            '<div class="col-12 col-12-medium">'+
                '<form method="post" id="formlogin">'+
                    ...
                    '</div>'+
                    '</form>'+
                '<p>Not have an account? <a id="register" href="index.php?page=controller_login&op=list">Register</a>.</p>'+
            '</div>'+
        '</div>'
    )
}
